...
import br.edu.utfpr.pb.oo24s.trabalhof.util.BooleanConverter;
...
public class Usuario implements AbstractModel, Serializable{
    ...
    public String toString() {
        return "Usuario{" + "id=" + id + ", nome=" + nome + ", cpf=" + cpf + ", email=" + email + ", senha=" + senha + ", ativo=" + ativo + ", dataNascimento=" + dataNascimento + ", foto=" + foto + ", contatos=" + contatos + '}';
    }
